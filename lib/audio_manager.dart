...
static Future<void> playPaperRustle() async {
  ...
  static Future<void> startCastleDrops() async {
    ...
    // =========================================================================
  // ТОЧЕЧНО ДОБАВЛЕНО: СИСТЕМНАЯ ПАУЗА ПРИ СВЕРТЫВАНИИ ИГРЫ
  // =========================================================================
  static Future<void> pauseAll() async {
    try {
      await _finalMenuPlayer.pause();
      await _rainPlayer.pause(); // Глушим звук дождя и капания (так как они сидят на одном плеере)
      print("Все звуковые потоки успешно поставлены на паузу.");
    } catch (e) {
  ...
  // =========================================================================
  // ТОЧЕЧНО ДОБАВЛЕНО: ВОЗОБНОВЛЕНИЕ ЗВУКОВ ПРИ ВОЗВРАЩЕНИИ В ИГРУ
  // =========================================================================
  static Future<void> resumeAll() async {
    try {
      // Проверяем состояние и мягко возвращаем звук в зависимости от того, где находится игрок
